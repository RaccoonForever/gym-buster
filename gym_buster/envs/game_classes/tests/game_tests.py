...
class GameTest(unittest.TestCase):
    ...
    def test_buster_busting_same_range(self):
        ...
        self.assertTrue(game.score_team_1 == 0)
        self.assertTrue(game.ghosts[0].x != game.busters[0].x and game.ghosts[0].x != game.busters[1].x)
        self.assertTrue(game.ghosts[0].y != game.busters[0].y and game.ghosts[0].y != game.busters[1].y)
